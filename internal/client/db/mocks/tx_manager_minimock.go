...
//go:generate minimock -i github.com/drewspitsin/chat-server/internal/client/db.TxManager -o ./mocks/tx_manager_minimock.go -n TxManagerMock
...
import (
	...
	mm_db "github.com/drewspitsin/chat-server/internal/client/db"
